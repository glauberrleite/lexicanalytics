...
/**
 * A Production is the entity that represents the text sample and its lexical
 * properties and measures that will be processed by the Analyzer.
 * 
...
public class Production {
	...
	/**
	 * To get a instance, only the text sample is needed as the other attributes
	 * will be set by the Analyzer.
	 * 
	 * @param text
	 *            The text sample
	 */
